...
-   `mjs_plot_`: Create a new metricsgraphics.js plot with variable s for x & y parameters **[NEW]**
-   `as_mjsplot`: Create a new metricsgraphics.js plot from basic ggplot objects **[NEW]**
...
-   Version 0.9.0.9000 released - Added support for using variables for x & y parameters and also a way to convert simple ggplot objects to metricsgraphics object with `as_mjsplot`

### Installation

``` r
install_github("hrbrmstr/metricsgraphics", ref="dev01")
```
...
#NEW ggplot CONVERSION ROUTINES
